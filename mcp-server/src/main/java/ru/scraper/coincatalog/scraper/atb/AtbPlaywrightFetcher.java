...
public class AtbPlaywrightFetcher {
    ...
    public AtbPlaywrightFetcher() {
        this(null);
    }

    AtbPlaywrightFetcher(Function<String, String> detailLoaderOverride) {
        this(true, Duration.ofMillis(30_000), 3, 0.5, detailLoaderOverride);
    }

    AtbPlaywrightFetcher(
            boolean headless,
            Duration timeout,
            int retries,
            double delaySeconds,
    ...
    public FetchResult fetchCatalog(String query, boolean investmentOnly) {
        ...
        try (Playwright playwright = Playwright.create()) {
            ...
            try (browser) {
                ...
                return new FetchResult(1, coins, fragment);
            }
        }
    }
    ...
    public record FetchResult(int pagesProcessed, List<Coin> coins, String fragmentHtml) {}
}
