...
public class LantaPlaywrightFetcher {
    ...
    public LantaPlaywrightFetcher() {
        this(null);
    }

    LantaPlaywrightFetcher(BiFunction<String, String, String> popupLoaderOverride) {
        this(true, Duration.ofMillis(60_000), 3, 0.5, DEFAULT_SCROLL_PASSES, popupLoaderOverride);
    }

    LantaPlaywrightFetcher(
            boolean headless,
            Duration timeout,
            int retries,
            double delaySeconds,
    ...
    public FetchResult fetchCatalog(String query, boolean investmentOnly) {
        ...
        try (Playwright playwright = Playwright.create()) {
            ...
            try (browser) {
                ...
                return new FetchResult(1, coins);
            }
        }
    }
