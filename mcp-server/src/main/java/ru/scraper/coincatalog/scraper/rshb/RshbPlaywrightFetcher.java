...
public class RshbPlaywrightFetcher {
    ...
    public RshbPlaywrightFetcher() {
        this(null);
    }

    RshbPlaywrightFetcher(BiFunction<PageLoadRequest, Page, Boolean> pageLoaderOverride) {
        this(true, Duration.ofMillis(30_000), 3, 5.0, RshbPageParser.DEFAULT_PAGE_SIZE, pageLoaderOverride);
    }

    RshbPlaywrightFetcher(
            boolean headless,
            Duration timeout,
            int retries,
    ...
    public FetchResult fetchCatalog(String query, boolean investmentOnly, String region) {
        ...
        try (Playwright playwright = Playwright.create()) {
            ...
            try (browser) {
                ...
                return new FetchResult(processed, allCoins);
            }
        }
    }
    ...
    public record FetchResult(int pagesProcessed, List<Coin> coins) {}
}
